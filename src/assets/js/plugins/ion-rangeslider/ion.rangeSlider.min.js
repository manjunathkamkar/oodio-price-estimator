	...
	h.prototype = {
			...
			moveByKey: function (t) {
				var i = this.coords.p_pointer,
					s = (this.options.max - this.options.min) / 1000;
			...
			calc: function (t) {
				if (this.options && (this.calc_count++, (10 === this.calc_count || t) && (this.calc_count = 0, this.coords.w_rs = this.$cache.rs.outerWidth(!1), this.calcHandlePercent()), this.coords.w_rs)) {
					...
					switch ("both" === this.target && (this.coords.p_gap = 0, i = this.getHandleX()), "click" === this.target && (this.coords.p_gap = this.coords.p_handle / 2, i = this.getHandleX(), this.options.drag_interval ? this.target = "both_one" : this.target = this.chooseHandle(i)), this.target) {
						case "base":
							var s = (this.options.max - this.options.min) / 1000,
						...
						case "both_one":
							...
							var h = this.convertToRealPercent(i),
								...
								c = h - a,
								l = h + a;
							c < 0 && (l = (c = 0) + n), 100 < l && (c = (l = 1000) - n), this.coords.p_from_real = this.calcWithStep(c), this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this.options.from_min, this.options.from_max), this.coords.p_from_fake = this.convertToFakePercent(this.coords.p_from_real), this.coords.p_to_real = this.calcWithStep(l), this.coords.p_to_real = this.checkDiapason(this.coords.p_to_real, this.options.to_min, this.options.to_max), this.coords.p_to_fake = this.convertToFakePercent(this.coords.p_to_real)
					}
			...
			convertToRealPercent: function (t) {
				return t / (1000 - this.coords.p_handle) * 1000
			},
			convertToFakePercent: function (t) {
				return t / 1000 * (1000 - this.coords.p_handle)
			},
			getHandleX: function () {
				var t = 1000 - this.coords.p_handle,
			...
			calcWithStep: function (t) {
				...
				return 100 < i && (i = 1000), 1000 === t && (i = 1000), this.toFixed(i)
			},
			...
			checkEdges: function (t, i) {
				return this.options.force_edges && (t < 0 ? t = 0 : 1000 - i < t && (t = 1000 - i)), this.toFixed(t)
			},
			validate: function () {
